...
4. Find your package entry in [package-sources.json](https://github.com/shmish111/smoke-hill/blob/main/nix/package-sources.json) and add a list of dependencies. If there are no dependencies you will still need to add a `dependencies = [],` attribute.
5. Add your package to the [packages derivation](https://github.com/shmish111/smoke-hill/blob/main/nix/packages.nix) using the form `packagename = mkIdrisPackage "packagename" ps;`
